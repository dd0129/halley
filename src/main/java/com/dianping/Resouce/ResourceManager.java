...
public class ResourceManager {
    ...
    public static synchronized boolean preemptResource(String resourceName){
        ...
        if(res == null){
            ...
            if(res.getRunningNum()<res.getLimit()){
                res.addRunningNum();
            ...
            logger.info(resourceName.concat(" resouce is full; limit :=" ).concat(String.valueOf(res.getLimit())));
            return false;
        }
    }

    public static synchronized void releaseResource(String resourceName){
        Resource res = RESOURCE_MAP.get(resourceName);
        if(res == null){
